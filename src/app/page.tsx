        ...
        <div className="mx-auto max-w-[1200px] px-6 md:px-8">
          ...
          >
            ...
            <button
              type="submit"
              disabled
              className="whitespace-nowrap rounded-lg bg-cream px-6 py-3.5 text-label font-semibold text-forest motion-safe:transition-opacity hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed"
              title="Kommer snart"
            >
              Meld meg pa
            </button>
