...
const forside: PageContent = {
  ...
  sections: [
    ...
    { id: 'opplevelser-grid', type: 'experiences-grid', heading: 'Kurs og Retreater', subheading: 'Book din neste naturopplevelse', order: 2 },
    { id: 'produkter-grid', type: 'products-grid', heading: 'Produkter fra norsk natur', order: 3 },
    { id: 'artikler-grid', type: 'articles-grid', heading: 'Fra bloggen', order: 4 },
    { id: 'cta-banner', type: 'cta', heading: 'Klar for en opplevelse?', subheading: 'Utforsk våre unike naturopplevelser og finn din neste eventyr i norsk natur.', image: { url: '/bilder-brukt-paa-sidene/opplevelser-retreat/retreat-20-desktop.webp', alt: 'Retreat i naturen' }, ctaText: 'Se opplevelser', ctaLink: '/opplevelser', order: 5 },
  ],
  updatedAt: new Date('2025-09-01'),
}
