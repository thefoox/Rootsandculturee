...
export const mockProducts: Product[] = [
  {
    ...
    name: 'Skogsbær-saft',
    description:
      'Håndplukket norsk skogsbærsaft laget av blåbær, tyttebær og bringebær fra dype skoger i Trøndelag. Saftig og naturlig søt uten tilsetningsstoffer. Perfekt til festlige anledninger eller som en daglig vitaminboost.',
    price: 14900,
    category: 'drikke',
...
const forside: PageContent = {
  ...
  navigationOrder: 0,
  sections: [
    { id: 'hero', type: 'hero', heading: 'Velkommen til\nRoots & Culture', subheading: 'Gjennom våre tjenester arbeider vi for å øke bevisstheten om natur, tradisjon og kultur.', image: { url: '/bilder-brukt-paa-sidene/opplevelser-retreat/retreat-20-desktop.webp', alt: 'Gruppe på tur i norsk skog' }, ctaText: 'Se tilgjengelige opplevelser', ctaLink: '/opplevelser', ctaSecondaryText: 'Besøk butikk', ctaSecondaryLink: '/produkter', order: 0 },
    { id: 'trust-bar', type: 'trust-bar', items: [{ title: 'Trygg betaling', description: 'Sikker betaling med Stripe', icon: 'shield' }, { title: 'Norsk kvalitet', description: 'Alle produkter fra norsk natur', icon: 'heart' }, { title: 'Lokale guider', description: 'Erfarne naturguider over hele Norge', icon: 'layers' }, { title: 'Gratis kansellering', description: 'Avbestill uten kostnad', icon: 'check-circle' }], order: 1 },
    { id: 'kategorier', type: 'categories' as const, heading: 'Utforsk vare kategorier', items: [{ title: 'Retreater', description: 'Koble av i naturen med guidede retreater', image: { url: '/bilder-brukt-paa-sidene/opplevelser-retreat/retreat-14-desktop.webp', alt: 'Retreater' }, href: '/opplevelser/retreat' }, { title: 'Kurs', description: 'Laer a sanke urter og opplev naturen', image: { url: '/bilder-brukt-paa-sidene/opplevelser-kurs/kurs-07-desktop.webp', alt: 'Kurs' }, href: '/opplevelser/kurs' }, { title: 'Matopplevelser', description: 'Smak pa norske tradisjoner', image: { url: '/bilder-brukt-paa-sidene/opplevelser-catering/catering-07-desktop.webp', alt: 'Matopplevelser' }, href: '/opplevelser/matopplevelse' }], order: 2 },
    { id: 'opplevelser-grid', type: 'experiences-grid', heading: 'Kurs og Retreater', subheading: 'Book din neste naturopplevelse', order: 3 },
    { id: 'produkter-grid', type: 'products-grid', heading: 'Produkter fra norsk natur', order: 4 },
    { id: 'omtaler', type: 'testimonials' as const, heading: 'Hva gjestene sier', items: [{ title: 'Kari Nordmann', description: 'En helt magisk opplevelse. A vaere ute i skogen med kunnskapsrike guider ga meg en ny respekt for norsk natur.', icon: 'Deltaker, Tidlig Var-retreat' }, { title: 'Erik Hansen', description: 'Vi tok med hele teamet pa bedriftsretreat. Fantastisk organisert og perfekt balanse mellom aktivitet og ro.', icon: 'CEO, Innovasjon AS' }, { title: 'Inger Larsen', description: 'Produktene er av topp kvalitet. Tors Ild er blitt min favoritt for morke kvelder.', icon: 'Kunde siden 2024' }], order: 5 },
    { id: 'artikler-grid', type: 'articles-grid', heading: 'Fra bloggen', order: 6 },
    { id: 'nyhetsbrev', type: 'newsletter' as const, heading: 'Hold deg oppdatert', subheading: 'Fa beskjed om nye opplevelser og sesong-tips', ctaText: 'Meld meg pa', order: 7 },
    { id: 'cta-banner', type: 'cta', heading: 'Klar for en opplevelse?', subheading: 'Utforsk våre unike naturopplevelser og finn din neste eventyr i norsk natur.', image: { url: '/bilder-brukt-paa-sidene/opplevelser-retreat/retreat-20-desktop.webp', alt: 'Retreat i naturen' }, ctaText: 'Se opplevelser', ctaLink: '/opplevelser', order: 8 },
  ],
  updatedAt: new Date('2025-09-01'),
}
...
const omOss: PageContent = {
  ...
  navigationOrder: 30,
  sections: [
    { id: 'hero', type: 'hero', heading: 'Om Roots & Culture', subheading: 'Forankret i norsk natur og kulturarv. Vi bringer deg naermere det ekte.', image: { url: '/bilder-brukt-paa-sidene/opplevelser-retreat/retreat-21-desktop.webp', alt: 'Norsk natur og kulturarv' }, order: 0 },
    { id: 'historie', type: 'text-image', heading: 'Var historie', subheading: '\u2014 Grunnleggerne av Roots & Culture', body: '<p>Roots & Culture ble startet med en enkel ide: a gjore det lettere for folk a oppleve det beste av norsk natur og kulturarv.</p><p>Fra starten har vi samarbeidet med lokale produsenter, bonder og naturguider som deler var lidenskap for norsk natur.</p><p>Enten du soker ro i skogen, vil laere om ville urter, eller drommer om mat laget over bal \u2014 vi har noe for deg.</p>', image: { url: '/bilder-brukt-paa-sidene/opplevelser-retreat/retreat-14-desktop.webp', alt: 'Var historie' }, order: 1 },
    { id: 'verdier', type: 'values', heading: 'Hva vi star for', subheading: 'Tre verdier som driver alt vi gjor', items: [{ title: 'Autentisitet', description: 'Alt vi tilbyr er ekte. Ekte naturopplevelser, ekte produkter fra norsk natur, ekte mennesker som brenner for det de gjor.', icon: 'layers' }, { title: 'Baerekraft', description: 'Vi tar vare pa naturen vi lever av. Alle opplevelser og produkter er utviklet med respekt for miljoet og lokale okosystemer.', icon: 'shield' }, { title: 'Fellesskap', description: 'Vi tror pa kraften i a dele opplevelser. Vare retreater og kurs skaper rom for a moetes, laere og vokse sammen.', icon: 'heart' }], order: 2 },
    { id: 'team', type: 'team', heading: 'Menneskene bak', items: [{ title: 'Navn Navnesen', description: 'Grunnlegger & Naturguide', image: { url: '/bilder-brukt-paa-sidene/opplevelser-retreat/retreat-21-desktop.webp', alt: 'Grunnlegger og naturguide' } }, { title: 'Navn Navnesen', description: 'Opplevelsesdesigner', image: { url: '/bilder-brukt-paa-sidene/opplevelser-kurs/kurs-07-desktop.webp', alt: 'Opplevelsesdesigner' } }, { title: 'Navn Navnesen', description: 'Kokk & Matformidler', image: { url: '/bilder-brukt-paa-sidene/opplevelser-catering/catering-07-desktop.webp', alt: 'Kokk og matformidler' } }], order: 3 },
    { id: 'lokasjon', type: 'location', heading: 'Hvor du finner oss', subheading: 'Vi holder til pa Holtan Gard i Sande, Vestfold \u2014 omgitt av skog, akerland og en av Norges vakreste kystlinjer.', body: 'dark', items: [{ title: 'Holtan Gard, Sande i Vestfold', description: '', icon: 'map-pin' }, { title: 'post@rootsculture.no', description: '', icon: 'mail' }, { title: '+47 123 45 678', description: '', icon: 'phone' }], order: 4 },
    { id: 'cta', type: 'cta', heading: 'Klar for en opplevelse?', subheading: 'Utforsk vare kommende opplevelser og finn noe som passer for deg.', ctaText: 'Se opplevelser', ctaLink: '/opplevelser', order: 5 },
  ],
  updatedAt: new Date('2025-09-01'),
}
...
const kontakt: PageContent = {
  ...
  navigationOrder: 40,
  sections: [
    { id: 'hero', type: 'hero', heading: 'Ta kontakt', subheading: 'Har du sporsmaal om opplevelser, produkter eller samarbeid? Vi svarer gjerne.', order: 0 },
    { id: 'kontakt-info', type: 'contact-info', heading: 'Kontaktmetoder', items: [{ title: 'E-post', description: 'Svar innen 24 timer', icon: 'mail', href: 'mailto:post@rootsculture.no' }, { title: 'Telefon', description: 'Man-Fre 09:00-17:00', icon: 'phone', href: 'tel:+4712345678' }, { title: 'Besok oss', description: 'Etter avtale', icon: 'map-pin' }], order: 1 },
    { id: 'faq', type: 'faq', heading: 'Ofte stilte sporsmaal', items: [{ title: 'Hvor lang tid tar det for dere svarer?', description: 'Vi svarer vanligvis innen 24 timer pa hverdager.' }, { title: 'Tilbyr dere bedriftsarrangementer?', description: 'Ja! Vi skreddersyr opplevelser for bedrifter.' }, { title: 'Kan jeg kansellere en booking?', description: 'Kanselleringsvilkarene varierer per opplevelse. Sjekk detaljsiden.' }, { title: 'Kan jeg gi en opplevelse i gave?', description: 'Absolutt! Kjop gavekort pa valgfri verdi i nettbutikken.' }, { title: 'Hvor finner jeg dere?', description: 'Holtan Gard i Sande, Vestfold. Ca. 1,5 timer fra Oslo.' }, { title: 'Har dere parkering?', description: 'Ja, gratis parkering pa garden. Veibeskrivelse sendes med bookingbekreftelsen.' }], order: 2 },
    { id: 'lokasjon', type: 'location', heading: 'Finn oss', subheading: 'Vi holder til pa Holtan Gard, omgitt av skog og en av Norges vakreste kystlinjer.', items: [{ title: 'Holtan Gard, Sande i Vestfold', description: '', icon: 'map-pin' }, { title: 'Man-Fre 09-17, Lor 10-15', description: '', icon: 'clock' }], order: 3 },
  ],
  updatedAt: new Date('2025-09-01'),
}
