...
const forside: PageContent = {
  ...
  sections: [
    ...
    { id: 'kategorier', type: 'categories' as const, heading: 'Utforsk våre kategorier', items: [{ title: 'Retreater', description: 'Koble av i naturen med guidede retreater', image: { url: '/bilder-brukt-paa-sidene/opplevelser-retreat/retreat-14-desktop.webp', alt: 'Retreater' }, href: '/opplevelser/retreat' }, { title: 'Kurs', description: 'Lær å sanke urter og opplev naturen', image: { url: '/bilder-brukt-paa-sidene/opplevelser-kurs/kurs-07-desktop.webp', alt: 'Kurs' }, href: '/opplevelser/kurs' }, { title: 'Matopplevelser', description: 'Smak på norske tradisjoner', image: { url: '/bilder-brukt-paa-sidene/opplevelser-catering/catering-07-desktop.webp', alt: 'Matopplevelser' }, href: '/opplevelser/matopplevelse' }], order: 2 },
    ...
    { id: 'omtaler', type: 'testimonials' as const, heading: 'Hva gjestene sier', items: [{ title: 'Kari Nordmann', description: 'En helt magisk opplevelse. Å være ute i skogen med kunnskapsrike guider ga meg en ny respekt for norsk natur.', icon: 'Deltaker, Tidlig Vår-retreat' }, { title: 'Erik Hansen', description: 'Vi tok med hele teamet på bedriftsretreat. Fantastisk organisert og perfekt balanse mellom aktivitet og ro.', icon: 'CEO, Innovasjon AS' }, { title: 'Inger Larsen', description: 'Produktene er av topp kvalitet. Tors Ild er blitt min favoritt for mørke kvelder.', icon: 'Kunde siden 2024' }], order: 5 },
    { id: 'artikler-grid', type: 'articles-grid', heading: 'Fra bloggen', order: 6 },
    { id: 'nyhetsbrev', type: 'newsletter' as const, heading: 'Hold deg oppdatert', subheading: 'Få beskjed om nye opplevelser og sesong-tips', ctaText: 'Meld meg på', order: 7 },
...
const omOss: PageContent = {
  ...
  navigationOrder: 30,
  sections: [
    { id: 'hero', type: 'hero', heading: 'Om Roots & Culture', subheading: 'Forankret i norsk natur og kulturarv. Vi bringer deg nærmere det ekte.', image: { url: '/bilder-brukt-paa-sidene/opplevelser-retreat/retreat-21-desktop.webp', alt: 'Norsk natur og kulturarv' }, order: 0 },
    { id: 'historie', type: 'text-image', heading: 'Vår historie', subheading: '\u2014 Grunnleggerne av Roots & Culture', body: '<p>Roots & Culture ble startet med en enkel idé: å gjøre det lettere for folk å oppleve det beste av norsk natur og kulturarv.</p><p>Fra starten har vi samarbeidet med lokale produsenter, bønder og naturguider som deler vår lidenskap for norsk natur.</p><p>Enten du søker ro i skogen, vil lære om ville urter, eller drømmer om mat laget over bål \u2014 vi har noe for deg.</p>', image: { url: '/bilder-brukt-paa-sidene/opplevelser-retreat/retreat-14-desktop.webp', alt: 'Vår historie' }, order: 1 },
    { id: 'verdier', type: 'values', heading: 'Hva vi står for', subheading: 'Tre verdier som driver alt vi gjør', items: [{ title: 'Autentisitet', description: 'Alt vi tilbyr er ekte. Ekte naturopplevelser, ekte produkter fra norsk natur, ekte mennesker som brenner for det de gjør.', icon: 'layers' }, { title: 'Bærekraft', description: 'Vi tar vare på naturen vi lever av. Alle opplevelser og produkter er utviklet med respekt for miljøet og lokale økosystemer.', icon: 'shield' }, { title: 'Fellesskap', description: 'Vi tror på kraften i å dele opplevelser. Våre retreater og kurs skaper rom for å møtes, lære og vokse sammen.', icon: 'heart' }], order: 2 },
    ...
    { id: 'lokasjon', type: 'location', heading: 'Hvor du finner oss', subheading: 'Vi holder til på Holtan Gård i Sande, Vestfold \u2014 omgitt av skog, åkerland og en av Norges vakreste kystlinjer.', body: 'dark', items: [{ title: 'Holtan Gård, Sande i Vestfold', description: '', icon: 'map-pin' }, { title: 'post@rootsculture.no', description: '', icon: 'mail' }, { title: '+47 123 45 678', description: '', icon: 'phone' }], order: 4 },
    { id: 'cta', type: 'cta', heading: 'Klar for en opplevelse?', subheading: 'Utforsk våre kommende opplevelser og finn noe som passer for deg.', ctaText: 'Se opplevelser', ctaLink: '/opplevelser', order: 5 },
  ],
  updatedAt: new Date('2025-09-01'),
}
...
const kontakt: PageContent = {
  ...
  navigationOrder: 40,
  sections: [
    { id: 'hero', type: 'hero', heading: 'Ta kontakt', subheading: 'Har du spørsmål om opplevelser, produkter eller samarbeid? Vi svarer gjerne.', order: 0 },
    { id: 'kontakt-info', type: 'contact-info', heading: 'Kontaktmetoder', items: [{ title: 'E-post', description: 'Svar innen 24 timer', icon: 'mail', href: 'mailto:post@rootsculture.no' }, { title: 'Telefon', description: 'Man-Fre 09:00-17:00', icon: 'phone', href: 'tel:+4712345678' }, { title: 'Besøk oss', description: 'Etter avtale', icon: 'map-pin' }], order: 1 },
    { id: 'faq', type: 'faq', heading: 'Ofte stilte spørsmål', items: [{ title: 'Hvor lang tid tar det før dere svarer?', description: 'Vi svarer vanligvis innen 24 timer på hverdager.' }, { title: 'Tilbyr dere bedriftsarrangementer?', description: 'Ja! Vi skreddersyr opplevelser for bedrifter.' }, { title: 'Kan jeg kansellere en booking?', description: 'Kanselleringsvilkårene varierer per opplevelse. Sjekk detaljsiden.' }, { title: 'Kan jeg gi en opplevelse i gave?', description: 'Absolutt! Kjøp gavekort på valgfri verdi i nettbutikken.' }, { title: 'Hvor finner jeg dere?', description: 'Holtan Gård i Sande, Vestfold. Ca. 1,5 timer fra Oslo.' }, { title: 'Har dere parkering?', description: 'Ja, gratis parkering på gården. Veibeskrivelse sendes med bookingbekreftelsen.' }], order: 2 },
    { id: 'lokasjon', type: 'location', heading: 'Finn oss', subheading: 'Vi holder til på Holtan Gård, omgitt av skog og en av Norges vakreste kystlinjer.', items: [{ title: 'Holtan Gård, Sande i Vestfold', description: '', icon: 'map-pin' }, { title: 'Man-Fre 09-17, Lør 10-15', description: '', icon: 'clock' }], order: 3 },
  ],
  updatedAt: new Date('2025-09-01'),
}
