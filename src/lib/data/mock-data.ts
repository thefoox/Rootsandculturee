...
const forside: PageContent = {
  ...
  sections: [
    ...
    { id: 'trust-bar', type: 'trust-bar', items: [{ title: 'Trygg betaling', description: 'Sikker betaling med Stripe', icon: 'shield' }, { title: 'Norsk kvalitet', description: 'Alle produkter fra norsk natur', icon: 'heart' }, { title: 'Lokale guider', description: 'Erfarne naturguider over hele Norge', icon: 'layers' }], order: 1 },
    { id: 'opplevelser-grid', type: 'experiences-grid', heading: 'Opplevelser', subheading: 'Naturretreater, kurs og matopplevelser som bringer deg naermere norsk natur og kulturarv', order: 2 },
    { id: 'produkter-grid', type: 'products-grid', heading: 'Produkter', subheading: 'Handplukkede naturprodukter fra norske produsenter', order: 3 },
    { id: 'om-oss', type: 'text-image', heading: 'Forankret i norsk natur', body: '<p>Roots & Culture er en norsk nettbutikk som formidler håndplukkede naturprodukter og unike opplevelser fra hele Norge. Vi samarbeider med lokale produsenter, bønder og guider som deler vår lidenskap for norsk natur og kulturarv.</p><p>Vårt mål er å gjøre det enkelt for deg å oppleve det beste Norge har å by på — enten det er gjennom en kopp urte-te fra fjellet eller et retreat ved fjorden.</p>', image: { url: '/bilder-brukt-paa-sidene/om-oss/retreat-07-desktop.webp', alt: 'Naturopplevelse i norsk skog' }, ctaText: 'Les mer om oss', ctaLink: '/om-oss', order: 4 },
    { id: 'artikler-grid', type: 'articles-grid', heading: 'Fra bloggen', subheading: 'Historier om natur, kultur og tradisjoner', order: 5 },
    { id: 'cta-banner', type: 'cta', heading: 'Klar for en opplevelse?', subheading: 'Utforsk våre unike naturopplevelser og finn din neste eventyr i norsk natur.', image: { url: '/bilder-brukt-paa-sidene/forside/retreat-20-desktop.webp', alt: 'Retreat i naturen' }, ctaText: 'Se opplevelser', ctaLink: '/opplevelser', order: 6 },
  ],
  updatedAt: new Date('2025-09-01'),
}
...
const omOss: PageContent = {
  ...
  sections: [
    ...
    { id: 'lokasjon', type: 'contact-info', heading: 'Hvor du finner oss', items: [{ title: 'Adresse', description: 'Holtan Gård, Sande i Vestfold', icon: 'map-pin' }, { title: 'E-post', description: 'post@rootsculture.no', icon: 'mail', href: 'mailto:post@rootsculture.no' }, { title: 'Telefon', description: '+47 123 45 678', icon: 'phone', href: 'tel:+4712345678' }], order: 5 },
    { id: 'cta', type: 'cta', heading: 'Klar for en opplevelse?', subheading: 'Utforsk våre kommende opplevelser og finn noe som passer for deg.', ctaText: 'Se opplevelser', ctaLink: '/opplevelser', order: 6 },
  ],
  updatedAt: new Date('2025-09-01'),
}
