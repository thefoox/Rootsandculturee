...
const pages = [
  ...
  },
  {
    ...
    sections: [
      ...
      { id: 'intro', type: 'text-image', heading: 'Naturopplevelser som berører', body: '<p>Hos Roots & Culture handler opplevelser om mer enn bare aktiviteter. Det handler om å stoppe opp, puste dypt, og kjenne forbindelsen til naturen rundt deg.</p><p>Hver opplevelse er nøye kuratert av erfarne guider som deler vår lidenskap for norsk natur og kulturarv.</p>', image: { url: '/bilder-brukt-paa-sidene/opplevelser-retreat/retreat-21-desktop.webp', alt: 'Naturopplevelse i norsk skog' }, ctaText: 'Se tilgjengelige opplevelser', ctaLink: '#opplevelser', order: 1 },
      { id: 'kategorier', type: 'categories', heading: 'Utforsk våre kategorier', order: 2 },
      { id: 'opplevelser-grid', type: 'experiences-grid', heading: 'Kommende opplevelser', subheading: 'Book din neste naturopplevelse', order: 3 },
      { id: 'artikler', type: 'articles-grid', heading: 'Fra bloggen', order: 4 },
      { id: 'faq', type: 'faq', heading: 'Vanlige spørsmål', items: [{ title: 'Hva inkluderer prisen?', description: 'Prisen inkluderer alt som er listet under «Hva er inkludert» på hver opplevelse. Sjekk detaljsiden for en fullstendig liste.' }, { title: 'Hvordan booker jeg?', description: 'Velg en opplevelse, velg en dato, og legg den i handlekurven. Fullfør betalingen med kort — du mottar bekreftelse på e-post.' }, { title: 'Kan jeg kansellere?', description: 'Ja. Kanselleringsvilkårene varierer og er oppgitt på detaljsiden. Generelt tilbyr vi gratis avbestilling inntil 7–21 dager før.' }, { title: 'Er opplevelsene tilpasset nybegynnere?', description: 'Ja, vi har opplevelser for alle nivåer — merket med lett, moderat eller krevende.' }, { title: 'Kan jeg gi en opplevelse i gave?', description: 'Absolutt! Kontakt oss på post@rootsculture.no så hjelper vi deg med gavekort.' }], order: 5 },
    ],
  },
  {
    id: 'retreat',
